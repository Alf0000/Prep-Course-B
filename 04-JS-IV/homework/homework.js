...
/* Debería ser length - 1.
  pero no me corre si se lo pongo.
  Dice que debería recorrer todos los likes*/

  for (var i=0; i < usuario.posts.length; i++){
    ContLikes_ = ContLikes_ + usuario.posts[i].likes
  }
